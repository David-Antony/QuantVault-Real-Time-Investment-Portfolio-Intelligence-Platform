...
function updateTransactionHistory() {
    ...
    html += '</tbody></table><div class="view-all-transactions" style="margin-top: 16px;"><a href="transactions.html" class="btn btn-secondary w-full" style="display: block; text-align: center;">View All Transactions</a></div>';
